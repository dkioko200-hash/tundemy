  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        isAvailable: true,
        content: "Production RAG systems add four concerns that development RAG ignores: latency (queries must return in under 2 seconds for good UX), cost (at scale, embedding and LLM API calls add up — $0.05 per query × 10,000 daily queries = $500/month), security (multi-tenant systems must ensure users only retrieve documents they own), and observability (you need to know when the system is failing in production without waiting for user complaints).",
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        type: "sandbox",
        hook: "The average Upwork proposal takes 8 minutes to write and gets rejected. A well-researched, client-specific proposal takes 25 minutes to write and wins at 4–5× the rate. The 17 extra minutes are the highest-ROI time investment in freelancing.",
        duration_mins: 40,
      ...
      },
      {
        ...
        theory: {
          ...
          goodBreakdown: [
            ...
            { element: "Specific outcome with numbers", present: "4 hours → 60 seconds, 150+ messages", improvement: "Proof of result before any pitch — reduces risk perception immediately" },
            ...
            { element: "Soft call to action", present: "'Happy to share how if relevant'", improvement: "Low-pressure — client says yes out of curiosity, not obligation. Response rate is 3-5× higher than 'please let me know if interested'" },
          ],
